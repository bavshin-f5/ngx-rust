...
use ngx::{
    ...
    ffi::{
        ...
        ngx_event_get_peer_pt, ngx_http_module_t, ngx_http_request_t, ngx_http_upstream_init_peer_pt,
    ...
    log::DebugMask,
    log::Level,
    ngx_log_debug_http, ngx_log_debug_mask, ngx_log_error, ngx_null_command, ngx_string,
};
use std::{
    mem,
