...
use ngx::ffi::{
    ...
    ngx_http_upstream_init_round_robin, ngx_http_upstream_srv_conf_t, ngx_http_upstream_t, ngx_int_t, ngx_module_t,
...
use ngx::{
    http_upstream_init_peer_pt, ngx_http_module_conf, ngx_log_debug_http, ngx_log_debug_mask, ngx_null_command,
    ngx_string,
};
