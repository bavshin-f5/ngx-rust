...
use ngx::core::{NgxConfRef, Status};
use ngx::ffi::{
    ...
    ngx_int_t, ngx_module_t, ngx_peer_connection_t, ngx_uint_t, NGX_CONF_NOARGS, NGX_CONF_TAKE1, NGX_CONF_UNSET,
    NGX_ERROR, NGX_HTTP_MODULE, NGX_HTTP_UPS_CONF, NGX_LOG_EMERG, NGX_RS_HTTP_SRV_CONF_OFFSET, NGX_RS_MODULE_SIGNATURE,
};
use ngx::http::{
...
use ngx::{
    http_upstream_init_peer_pt, ngx_log_debug_http, ngx_log_debug_mask, ngx_null_command, ngx_string, ForeignTypeRef,
};
