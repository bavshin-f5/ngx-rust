...
///
/// # Safety
/// Caller of configuration access methods must ensure that pointers to configuration structures
/// inside objects used as parameters are NULL or refer to valid configuration data.
